...
\begin{subsectionproject}{PVD Image Steganography}{Personal}{\gitRepo{github.com/UTkbxRME7c9C/pvd-image-steganography}{Project Repo}}
...
\begin{subsectionproject}{PySweeper}{Personal}{\gitRepo{github.com/UTkbxRME7c9C/pysweeper}{Project Repo}}
    \item{Developed a Minesweeper game in Python using the Pygame library, by implementing a graphical user interface and event handling.}
